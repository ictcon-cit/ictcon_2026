        ...
        <div className="flex flex-col flex-[4] bg-white  overflow-hidden shadow-sm">
          ...
          <div className=" flex-1 flex flex-col items-center justify-start text-center text-xl text-black ">
            ...
            <p className="text-left text-md text-justify-start leading-relaxed p-2 m-4">
              ...
              and to impart Bodo youths with requisite technological and vocational
              training to produce the required manpower to give the impetus to
              economic growth of this area and to integrate the Bodo People into
              the mainstream of Technical and Vocational Education. It is a
              Centrally Funded Institute under the Ministry of Human Resource
